...
request.open("GET","https://624d2af5d71863d7a8143760.mockapi.io/paginarion",true);
request.send();
request.onload = function(){
    ...
    var tab = document.getElementById("myTable").createCaption();
tab.innerHTML = "<b>Pagination Task-6</b>";
}
